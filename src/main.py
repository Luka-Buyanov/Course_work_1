...
def main() -> None:
    """Функция выводящая результат работы проекта"""

    print("Результат работы модуля views:")
    print(main_views("30.03.2019"))
    print("\nРезультат работы модуля services:")
    print(
    ...
    with open("../logs/result.log") as file:
        outputs = file.read()
        print(
            f"""\nРезультат работы модуля reports:
{outputs}"""
        )
